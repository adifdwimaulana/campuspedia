                  ...
                  <form action="{{url('/admin/major/store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="form-group col-md-12">
                        ...
                        <input type="text" name="nama_jurusan" class="form-control" placeholder="Nama Jurusan" id="nama_jurusan" required>
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-md-12">
                        <label for="deskripsi_jurusan" class="form-control-label">Deskripsi Jurusan</label>
                        <textarea name="deskripsi_jurusan" id="deskripsi_jurusan" class="form-control" placeholder="Deskripsi Jurusan" required rows="10"></textarea>
                      </div>
                    </div>
                    <div class="row">
                    <div class="form-group col-md-4">
                        <label for="daya_tampung" class="form-control-label">Daya Tampung</label>
                        <input type="number" id="daya_tampung" name="daya_tampung" class="form-control" required>
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="nama_fakultas" id="nama_fakultas" class="form-control" required>
                          <option value="" disable selected>--Pilih Fakultas--</option>
                        </select>
                    </div>
                    </div>
                    <div class="row">
