                  ...
                  <form action="{{url('/company/edit_perusahaan')}}" method="post" enctype="multipart/form-data" id="add_trans" autocomplete="off">
                    ...
                    <div class="row">
                      <div class="form-group col-md-12">
                        <input name="id" class="form-control" id="id" type="hidden" placeholder="ID" autocomplete="off" required value="{{ $perusahaan->id }}">
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-md-12">
                        <label class="form-control-label font-weight-bold" for="inputBasicFirstName">Nama Perusahaan</label>
                        <input name="nama_perusahaan" class="form-control" id="nama_perusahaan" type="text" placeholder="Nama Perusahaan" autocomplete="off" required value="{{ $perusahaan->nama_perusahaan }}">
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-md-6">
                        ...
                        <select id="negara" name="negara" class="form-control" required>
                            <option value="{{ $perusahaan->negara }}" selected>{{ $perusahaan->negara }}</option>
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <select id="tipe_industri" name="tipe_industri" class="form-control" required>
                            <option value="{{ $perusahaan->tipe_industri }}" selected>{{ $perusahaan->tipe_industri }}</option>
                    ...
                    <div class="form-group">
                      ...
                      <input name="alamat" class="form-control" id="alamat" type="text" placeholder="Alamat Perusahaan" autocomplete="off" required value="{{ $perusahaan->alamat_perusahaan }}">
                    </div>
                    <div class="row">
                      <div class="form-group col-md-12">
                        <label class="form-control-label font-weight-bold" for="inputBasicFirstName">Link Website</label>
                        <input name="website" class="form-control" id="website" type="text" placeholder="Link Website" autocomplete="off" required value="{{ $perusahaan->link_website }}">
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-md-6">
                        <label class="form-control-label font-weight-bold" for="inputBasicFirstName">Link Twitter</label>
                        <input name="twitter" class="form-control" id="twitter" type="text" placeholder="Link Twitter" autocomplete="off" required value="{{ $perusahaan->link_twitter }}">
                      </div>
                      <div class="form-group col-md-6">
                        <label class="form-control-label font-weight-bold" for="inputBasicLastName">Link LinkedIn</label>
                        <input name="LinkedIn" class="form-control" id="LinkedIn" type="text" placeholder="Link LinkedIn" autocomplete="off" required value="{{ $perusahaan->link_linkedin }}">
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-md-6">
                        <label class="form-control-label font-weight-bold" for="inputBasicFirstName">Link Facebook</label>
                        <input name="facebook" class="form-control" id="facebook" type="text" placeholder="Link Facebook" autocomplete="off" required value="{{ $perusahaan->link_facebook }}">
                      </div>
                      <div class="form-group col-md-6">
                        <label class="form-control-label font-weight-bold" for="inputBasicLastName">Link Instagram</label>
                        <input name="instagram" class="form-control" id="instagram" type="text" placeholder="Link Instagram" autocomplete="off" required value="{{ $perusahaan->link_instagram }}">
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-md-12">
