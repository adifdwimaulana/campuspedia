      ...
      <div>
        <div>
          <ul class="site-menu">
            ...
            <li class="site-menu-item">
              <a href="{{URL::to('/admin/list_paket')}}">
                <i class="site-menu-icon wb-plugin" aria-hidden="true"></i>
                <span class="site-menu-title">Paket</span>
              </a>
            </li>
            ...
            <li class="site-menu-item has-sub">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/list_user')}}">
                    <span class="site-menu-title">List Peserta</span>
                  </a>
                </li>
                <!-- <li class="site-menu-item">
                  <a class="animsition-link" href="../uikit/dropdowns.html">
                    <span class="site-menu-title">Peserta Sudah tervalidasi</span>
                  </a>
                </li> -->
              </ul>
            </li>
            <li class="site-menu-item has-sub">
              <a href="javascript:void(0)">
                ...
                <span class="site-menu-title">Tutor</span>
                <span class="site-menu-arrow"></span>
              </a>
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/list_tutor')}}">
                    <span class="site-menu-title">List Tutor Baru</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/list_tutor_interview')}}">
                    <span class="site-menu-title">List Tutor Interview</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/list_tutor_valid')}}">
                    <span class="site-menu-title">Tutor Tervalidasi</span>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="site-menu-item has-sub">
              <a href="javascript:void(0)">
                <i class="site-menu-icon wb-plugin" aria-hidden="true"></i>
                <span class="site-menu-title">Request Les</span>
                <span class="site-menu-arrow"></span>
              </a>
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/request_baru')}}">
                    <span class="site-menu-title">Request Baru</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/pending_approval')}}">
            ...
            <li class="site-menu-item">
              <a class="animsition-link" href="{{ URL::to('/admin/list_jam_mengajar')}}">
                <i class="site-menu-icon wb-time" aria-hidden="true"></i>
                <span class="site-menu-title">Jam Mengajar</span>
              </a>
            </li>
            </li>
            <li class="site-menu-category">Finance</li>
            <li class="site-menu-item has-sub">
              <a href="javascript:void(0)">
                <i class="site-menu-icon wb-plugin" aria-hidden="true"></i>
                <span class="site-menu-title">Order Les</span>
                <span class="site-menu-arrow"></span>
              </a>
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/order_les')}}">
                    <span class="site-menu-title">New Order Les</span>
                  </a>
                </li>
                <!-- <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/pending_approval')}}">
            ...
            <!-- <li class="site-menu-category">HRD</li>
            <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/seleksi_offline')}}">
                    <span class="site-menu-title">Seleksi Offline</span>
                  </a>
            </li>
            <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/seleksi_online')}}">
            ...
            <li class="site-menu-item">
              <a href="{{URL::to('/company/perusahaan')}}">
                <i class="site-menu-icon wb-plugin" aria-hidden="true"></i>
                <span class="site-menu-title">Perusahaan</span>
              </a>
            </li>
            <li class="site-menu-item">
              <a href="{{URL::to('/company/pekerjaan')}}">
                <i class="site-menu-icon wb-plugin" aria-hidden="true"></i>
