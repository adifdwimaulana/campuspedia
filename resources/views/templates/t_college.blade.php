          ...
          <ul class="site-menu">
            ...
            <li class="site-menu-item has-sub">
              <a href="javascript:void(0)">
                ...
                <span class="site-menu-title">Kampus</span>
                <span class="site-menu-arrow"></span>
              </a>
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/college/create')}}">
                    <span class="site-menu-title">Input Data Kampus</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/college')}}">
                    <span class="site-menu-title">List Kampus</span>
                  </a>
                </li>
                <li class="site-menu-item">
            ...
            <li class="site-menu-item has-sub">
              <a href="javascript:void(0)">
                <i class="site-menu-icon wb-plugin" aria-hidden="true"></i>
                <span class="site-menu-title">Fakultas</span>
                <span class="site-menu-arrow"></span>
              </a>
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/faculty/create')}}">
                    <span class="site-menu-title">Input Fakultas</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/faculty')}}">
                    <span class="site-menu-title">List Fakultas</span>
                  </a>
                </li>
                <li class="site-menu-item">
            ...
            <li class="site-menu-item has-sub">
              ...
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/major/create')}}">
                    <span class="site-menu-title">Input Jurusan</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/major')}}">
                    <span class="site-menu-title">List Jurusan</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/admin/list_private')}}">
