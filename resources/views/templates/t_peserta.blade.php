...
<head>
  ...
  <title>Peserta Dashboard | Excent Private</title>
...
<body class="ecommerce_dashboard">
    ...
    <div class="navbar-container container-fluid">
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              <li role="presentation">
                <a href="{{URL::to('/peserta/profil')}}" role="menuitem"><i class="icon wb-user" aria-hidden="true"></i> Profile</a>
              </li>
              <!-- <li role="presentation">
              ...
              <li role="presentation">
                <a href="{{URL::to('/peserta/logout')}}" role="menuitem"><i class="icon wb-power" aria-hidden="true"></i> Logout</a>
              </li>
            </ul>
          </li>
          <!-- <li class="dropdown">
          ...
          <li class="dropdown">
            <a data-toggle="dropdown" href="javascript:void(0)" title="Keranjang" aria-expanded="false"
            data-animation="scale-up" role="button">
              <i class="fa fa-shopping-bag" aria-hidden="true"></i>
              <span class="badge badge-danger up">{{Cart::count()}}</span>
            </a>
            <ul class="dropdown-menu dropdown-menu-right dropdown-menu-media" role="menu">
              <li class="dropdown-menu-header" role="presentation">
                <h5>Keranjang</h5>
                <span class="label label-round label-danger">{{Cart::count()}} item</span>
              </li>
                    ...
                    <a class="list-group-item" href="javascript:void(0)" role="menuitem">
                      <div class="media">
                        ...
                        <div class="media-body">
                          ...
                          <time class="media-meta">Qty:{{$row->qty}} - Harga: Rp {{$row->price}}</time>
                        </div>
                      </div>
                    </a>
                  @endforeach
              ...
              <li class="dropdown-menu-footer" role="presentation">
                <a href=""><button class="btn btn-sm btn-primary">Lihat Semua</button></a>
              </li>
            </ul>
          </li>
        </ul>
  ...
  <div class="site-menubar site-menubar-light">
          ...
          <ul class="site-menu">
            ...
            <li class="site-menu-item has-sub">
              <a href="javascript:void(0)">
                ...
                <span class="site-menu-title">Pesan Les</span>
                <span class="site-menu-arrow"></span>
              </a>
              <ul class="site-menu-sub">
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/peserta/request_les')}}">
                    <span class="site-menu-title">Paket Les</span>
                  </a>
                </li>
                <li class="site-menu-item">
                  <a class="animsition-link" href="{{URL::to('/peserta/list_pesanan')}}">
                    <span class="site-menu-title">List Pesanan</span>
                  </a>
                </li>
              </ul>
            </li>
            <li class="icons__item site-menu-item">
              <a href="{{URL::to('/peserta/konfirm_bayar')}}">
                <i class="site-menu-icon wb-user" aria-hidden="true"> </i>
                <span class="site-menu-title">  Konfirmasi Pembayaran</span>
              </a>
            </li>
            <li class="site-menu-item">
              <a href="{{URL::to('/peserta/privat')}}">
                <i class="site-menu-icon wb-plugin" aria-hidden="true"></i>
                <span class="site-menu-title">Private</span>
              </a>
            </li>
            <li class="site-menu-item">
              <a href="{{URL::to('/peserta/group')}}">
                <i class="site-menu-icon wb-plugin" aria-hidden="true"></i>
                <span class="site-menu-title">Group</span> 
              </a>
            </li>
            <li class="icons__item site-menu-item">
              <a href="{{URL::to('/peserta/histori_les')}}">
                <i class="site-menu-icon wb-chat-text" aria-hidden="true"></i>
                <span class="site-menu-title">Histori Les</span>
              </a>
            </li>
            <!-- <li class="site-menu-item">
              <a href="URL::to('/peserta/group')">
    ...
    <div class="site-menubar-footer">
      ...
      <a href="{{URL::to('/peserta/logout')}}" data-placement="top" data-toggle="tooltip" data-original-title="Logout">
 ...
 @yield('content')
  ...
  <script type="text/javascript">
      ...
      //     var my_url = "{{URL::to('/peserta/add_cart')}}";
      //     var rowId;
      //     var formData = {
      //       '_token': token,
      //       'rowId': rowId
